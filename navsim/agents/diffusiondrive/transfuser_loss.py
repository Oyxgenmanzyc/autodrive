...
def transfuser_loss(
    ...
    if 'diffusion_loss' in predictions:
        ...
        diffusion_loss = 0
    future_speed_loss = predictions.get('future_speed_loss', 0)
    loss = (
        config.trajectory_weight * trajectory_loss
        + config.diff_loss_weight * diffusion_loss
        + config.future_speed_loss_weight * future_speed_loss
    ...
    loss_dict = {
        ...
        'future_speed_loss': config.future_speed_loss_weight*future_speed_loss,
